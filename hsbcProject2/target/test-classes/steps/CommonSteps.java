...
public class CommonSteps {
	...
	public void filesValidator() {
		...
		readFileAndMapToObject();
	}

	
	private void readFileAndMapToObject() {
		
		// Here I will scan files and map it to the objects Instrument and Trades
	}
